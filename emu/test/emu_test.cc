...
TEST_F(EmulatorTest, SDF_ExternalEncDec_ECC) {
    ...
    unsigned char pubkey_test[64] = {
        0xA2, 0xC0, 0x57, 0xAE, 0x2D, 0x89, 0x4C, 0xDD,
        0x31, 0x2B, 0xA7, 0x1D, 0x05, 0x22, 0x1D, 0x73,
        0xC4, 0x2A, 0x68, 0xE4, 0x1D, 0x3B, 0x6E, 0x01,
        0x7E, 0x3F, 0x65, 0xED, 0x29, 0x20, 0x62, 0xA2,
        0x18, 0x21, 0x5F, 0x8B, 0xF0, 0xAF, 0x80, 0x91,
        0x33, 0xE0, 0xFC, 0xB8, 0x75, 0xCD, 0x16, 0x84,
        0x8D, 0x2F, 0x3C, 0xEB, 0x58, 0x46, 0xA7, 0xA2,
        0x40, 0xFB, 0x77, 0x23, 0xBF, 0x4B, 0xD0, 0x90
    };
    unsigned char prikey_test[32] = {
        0x24, 0x3E, 0x1E, 0x02, 0x77, 0xDB, 0xD2, 0xD7,
        0x67, 0x21, 0xC9, 0x1D, 0x0A, 0x39, 0xF1, 0x15,
        0xA0, 0x20, 0x95, 0x76, 0xB0, 0x5D, 0xCF, 0x8E,
        0x45, 0xCD, 0x20, 0x2B, 0x9E, 0x0B, 0xFB, 0x37
    };
    ...
    rv = SDF_ExternalEncrypt_ECC(session_handle,
                                 SGD_SM2_3,
                                 &st_pub_key,
                                 plain_data,
                                 plain_len,
