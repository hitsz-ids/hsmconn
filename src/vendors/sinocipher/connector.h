...
class Connector : public hsmc::Connector {
 ...
 private:
  ...
  using SDF_OpenDeviceWithConfigPath_t = int (*)(void **phDeviceHandle, unsigned char *configPath);
  SDF_OpenDeviceWithConfigPath_t SDF_OpenDeviceWithConfigPath_;
};
